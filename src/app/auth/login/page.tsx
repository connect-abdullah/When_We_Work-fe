    ...
    <AuthLayout
      ...
      subtitle={
        <>
          ...
          <Link href="/auth/signup" className="font-medium text-[#5A6ACF] hover:text-[#4A5ABF]">
            Sign up
          </Link>
        </>
      }
      ...
      <form className="space-y-5 w-full" onSubmit={handleSubmit}>
            ...
            <div className="text-center pt-4">
              <p className="text-xs text-gray-500 leading-relaxed">
                ...
                <Link href="/terms" className="text-[#5A6ACF] hover:text-[#4A5ABF] font-medium">
                  Terms of Service
                </Link>{' '}
                and{' '}
                <Link href="/privacy" className="text-[#5A6ACF] hover:text-[#4A5ABF] font-medium">
                  Privacy Policy
                </Link>
              </p>
            </div>
