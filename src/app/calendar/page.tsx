                  ...
                  <div className="relative">
                    ...
                    {showFilterDropdown && (
                      <div className="absolute right-0 mt-1 w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
                        <div className="p-2">
                          <p className="text-[9px] font-medium text-gray-700 mb-1.5 px-2">Filter Staff</p>
                          {resources.map((resource) => (
                            ...
                            >
                              <input
                                type="checkbox"
                                checked={filteredResources.includes(resource.id)}
                                onChange={() => toggleResource(resource.id)}
                                className="w-3 h-3 text-[#5A6ACF] border-gray-300 rounded focus:ring-[#5A6ACF]"
                              />
                              <span className="text-[10px] text-gray-700">{resource.name}</span>
                            </label>
                          ))}
                        </div>
                      </div>
