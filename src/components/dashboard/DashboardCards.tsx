...
const DashboardCards: React.FC<DashboardCardsProps> = ({ className }) => {
  return (
    <div className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-2 sm:gap-4 m-1 sm:m-2 ${className || ''}`}>
        ...
        return (
          ...
          >
            <div className="flex items-center justify-between">
              <h1 className="text-lg sm:text-xl font-medium text-[#1F384C]">{item.value}</h1>
