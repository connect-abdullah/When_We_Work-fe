...
const BusinessMetricsCards: React.FC<BusinessMetricsCardsProps> = ({ className = '', dateRange = '7days' }) => {
  ...
  return (
    <div className={`grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-8 gap-2 sm:gap-4 m-1 sm:m-2 ${className}`}>
